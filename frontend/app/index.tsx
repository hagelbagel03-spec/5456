  ...
  const handleVacationApproval = async (vacationId, action, reason) => {
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert('❌ Fehler', 'Fehler beim Bearbeiten des Antrags');
      }
    } catch (error) {
...
• Sicherheitsrelevante Ereignisse`}
      ...
      {/* Team Creation Modal - Like AddUser Style */}
      <Modal
        ...
        >
          <View style={dynamicStyles.profileModalOverlay}>
            ...
            <ScrollView style={dynamicStyles.profileModalContent} showsVerticalScrollIndicator={false}>
              ...
              <View style={dynamicStyles.formGroup}>
                <Text style={dynamicStyles.formLabel}>👥 Team-Mitglieder</Text>
                <TouchableOpacity
                  style={dynamicStyles.addMemberButton}
                  onPress={() => {
                ...
                >
                  ...
                  <Text style={dynamicStyles.addMemberText}>Benutzer auswählen ({selectedUsers.length})</Text>
                </TouchableOpacity>
                <Text style={dynamicStyles.memberHint}>
                  💡 Tipp: Erstellen Sie zuerst das Team, dann können Sie Benutzer zuweisen
                </Text>
              </View>
